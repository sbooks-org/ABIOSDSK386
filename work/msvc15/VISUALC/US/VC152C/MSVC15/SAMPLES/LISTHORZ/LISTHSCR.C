...
BOOL __export CALLBACK FInitListboxExtents(HWND hList)
{
    HANDLE      hMem;
    WORD        *pw;
...
BOOL __export CALLBACK FFreeListboxExtents(HWND hList)
{
    HANDLE      hMem;
    BOOL        fSuccess;
...
void __export CALLBACK ResetListboxExtents(HWND hList)
{
...
WORD __export CALLBACK WAddExtentEntry(HWND hList, LPSTR psz)
{
    HANDLE      hMem;
    WORD        cExtentEntries;
...
WORD __export CALLBACK WRemoveExtentEntry(HWND hList, WORD iSel)
{
    WORD        *pw;       //Pointer to extent memory.
    WORD        cExtentEntries;
    WORD        cExtentEntriesMax;
