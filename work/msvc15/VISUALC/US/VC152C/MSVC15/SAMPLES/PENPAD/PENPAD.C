 ...
 *                                      *
 ****************************************************************************/
LONG FAR PASCAL __export PPFrameWndProc ( hwnd, msg, wParam, lParam )
...
LONG FAR PASCAL __export PPMDIChildWndProc ( hwnd, msg, wParam, lParam )
...
LONG FAR PASCAL __export FakeProc ( hwnd, msg, wParam, lParam )
