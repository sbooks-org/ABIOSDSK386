...
char szDirName[256];	      // last Directory this Instance saw
/*************************************************************************
...
/*************************************************************************
  ...
  Comments:
   ...
   History:   Date     Reason
             ...
             6/27/91   Created
             11/2/92	Moved to _TEXT segment to allow call into C runtime

*************************************************************************/

BOOL FAR PASCAL __export FileOpenHookProc (HWND hDlg, WORD msg, WORD wParam, LONG lParam)
{
  INFOSTRUCT info;
  FARPROC    lpInfo;
...
BOOL FAR PASCAL __export InfoDlgProc (HWND hDlg, WORD message, WORD wParam, LONG lParam)
{
  INFOSTRUCT * pInfo;
  char         szBuffer[20];
...
BOOL FAR PASCAL __export FileSaveHookProc (HWND hDlg, WORD msg, WORD wParam, LONG lParam)
{
  HANDLE    hDibInfo;
  LPDIBINFO ptr;
  HWND      hGroup;
