 ...
 *									    *
 ****************************************************************************/
long FAR PASCAL __export OwnComboWndProc (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
 ...
 *									    *
 ****************************************************************************/
BOOL FAR PASCAL __export ListBoxExample (HWND hDlg, unsigned message, WORD wParam, LONG lParam)
 ...
 *									    *
 ****************************************************************************/
BOOL FAR PASCAL __export ComboBoxExample(HWND hDlg, unsigned message, WORD wParam, LONG lParam)
{
 ...
 *									    *
 ****************************************************************************/
BOOL FAR PASCAL __export OwnerComboBoxExample (HWND hDlg, unsigned message, WORD wParam, LONG lParam)
