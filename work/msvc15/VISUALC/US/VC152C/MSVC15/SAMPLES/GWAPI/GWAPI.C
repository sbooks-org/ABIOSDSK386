...
/******************* Public procedures **************************************/
LONG __export WINAPI GWRWndProc(HWND, UINT, WPARAM, LPARAM);

// this proto will have to be duplicated in caller:
REC  __export WINAPI GetWriting(LPRC, LPSTR, int, LPHANDLE);
...
*/
UINT __export WINAPI _WEP(int nParam)
	{
	nParam;	// noref
...
*/
REC __export WINAPI GetWriting(
...
*/
LONG __export WINAPI GWRWndProc(
