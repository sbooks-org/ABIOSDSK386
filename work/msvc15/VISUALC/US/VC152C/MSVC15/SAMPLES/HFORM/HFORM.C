...
***************************************************************/
    ...
    if (hwndMain = CreateWindow((LPSTR)szHformClass, 
        ...
        hAccel = LoadAccelerators (hInstance, MAKEINTRESOURCE(IDHFORM));
...
LONG FAR PASCAL __export HformWndProc(HWND hwnd, UINT message,
...
HANDLE FAR PASCAL __export SampleDlgProc(HWND hdlg, WORD message, WORD wParam, LONG lParam)
/***************************************************************
