...
REC WINAPI __export RecognizeInternal(LPRC, LPFUNCRESULTS);
REC WINAPI RecognizeDataInternal(LPRC,HPENDATA,LPFUNCRESULTS);
UINT WINAPI __export ConfigRecognizer(UINT,WPARAM,LPARAM); 
BOOL WINAPI __export InitRecognizer(LPRC); 
BOOL WINAPI __export InitRecognizer(LPRC); 
BOOL WINAPI __export TrainInkInternal(LPRC,HPENDATA,LPSYV);
BOOL WINAPI __export TrainContextInternal(LPRCRESULT,LPSYE,int,LPSYC,int);
...
Returns: 1
*/
WORD FAR PASCAL __export WEP(int nParam)
   {
   Unused(nParam);
...
Comment: DLL receives this call when an application calls
         InstallRecognizer.
*/
BOOL WINAPI __export InitRecognizer(LPRC lprc)     /* Ptr to RC struct */
   {
   Unused(lprc);
...
Cond:    DLL receives this call when an application calls
         UninstallRecognizer.
*/
VOID WINAPI __export CloseRecognizer(VOID)
   {
...
*/
UINT WINAPI __export ConfigRecognizer(
...
Cond:    --
*/
BOOL WINAPI __export TrainInkInternal(
...
Cond:    --
*/
BOOL WINAPI __export TrainContextInternal(
...
*/
REC WINAPI __export RecognizeInternal(
   LPRC lprc,                    /* Ptr to RC struct */
