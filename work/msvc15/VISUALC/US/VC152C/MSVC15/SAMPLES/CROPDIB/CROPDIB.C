...
BOOL FAR PASCAL __export AboutDlgProc(HWND hwnd, unsigned wMsg,WORD wParam, LONG lParam);
BOOL FAR PASCAL __export CropDIBDlgProc(HWND hwnd, unsigned wMsg,WORD wParam, LONG lParam);
 ...
 */
BOOL FAR PASCAL __export CropDIBDlgProc(
    HWND     hwnd,              // Window handle of "about" dialog box
    unsigned wMsg,              // Message number
    WORD     wParam,            // Message-dependent parameter
    LONG     lParam )           // Message-dependent parameter
