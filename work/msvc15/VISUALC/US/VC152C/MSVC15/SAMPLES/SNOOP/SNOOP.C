...
long FAR PASCAL __export SnoopWndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
/***************************************************************************
...
***************************************************************************/
long FAR PASCAL __export RoHeditProc(HWND hwnd, unsigned message, WORD wParam, long lParam)
    {
    switch(message)
        {
        case WM_SETCURSOR:
