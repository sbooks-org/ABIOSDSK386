...
BOOL FAR PASCAL __export fnInsertNew(  //- ENTRY:
...
BOOL FAR PASCAL __export fnProperties(          //- ENTRY:
...
BOOL FAR PASCAL __export fnInvalidLink(//- ENTRY:
...
BOOL FAR PASCAL __export fnAbout(      //- ENTRY:
   HWND           hDlg,                //- standard windows dialog box
   unsigned       message,
   WORD           wParam,
   LONG           lParam
...
BOOL FAR PASCAL __export fnRetry(      //- ENTRY
