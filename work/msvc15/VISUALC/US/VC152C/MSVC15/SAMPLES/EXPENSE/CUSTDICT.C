...
int __export CALLBACK LibMain(HANDLE hInstance, WORD wDataSeg
...
VOID __export CALLBACK _WEP(int nParameter)
/***************************************************************
...
int __export CALLBACK DictionaryProc(	int irq, LPVOID lpIn, LPVOID lpOut, int cbMax
