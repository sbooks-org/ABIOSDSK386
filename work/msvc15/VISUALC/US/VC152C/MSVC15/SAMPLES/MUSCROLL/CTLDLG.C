...
WORD FAR PASCAL _export WTranslateCtlFlags(DWORD dwStyle, LPSTR psz, WORD cchMax)
    {
    WORD        cch=0;
    LPSTR       pszT;
...
BOOL FAR PASCAL _export FShowCtlStyleDlg(HWND hWnd, HANDLE hMem,
...
BOOL FAR PASCAL _export FCtlStyleDlgProc(HWND hDlg, WORD wMessage, WORD wParam, LONG lParam)
    {
