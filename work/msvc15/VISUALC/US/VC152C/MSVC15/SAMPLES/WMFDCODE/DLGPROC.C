...
BOOL FAR PASCAL __export WMFRecDlgProc(hDlg, message, wParam, lParam)
HWND hDlg;
unsigned message;
WORD wParam;
LONG lParam;
...
BOOL FAR PASCAL __export EnumRangeDlgProc(hDlg, message, wParam, lParam)
...
BOOL FAR PASCAL __export PlayFromListDlgProc(hDlg, message, wParam, lParam)
HWND hDlg;
unsigned message;
WORD wParam;
LONG lParam;
...
BOOL FAR PASCAL __export HeaderDlgProc(hDlg, message, wParam, lParam)
HWND hDlg;                                /* window handle of the dialog box */
unsigned message;                         /* type of message                 */
WORD wParam;                              /* message-specific information    */
LONG lParam;
...
BOOL FAR PASCAL __export AldusHeaderDlgProc(hDlg, message, wParam, lParam)
HWND hDlg;                                /* window handle of the dialog box */
unsigned message;                         /* type of message                 */
WORD wParam;                              /* message-specific information    */
LONG lParam;
...
BOOL FAR PASCAL __export ClpHeaderDlgProc(hDlg, message, wParam, lParam)
HWND hDlg;
unsigned message;
WORD wParam;
LONG lParam;
...
BOOL FAR PASCAL __export ListDlgProc(hDlg, message, wParam, lParam)
HWND hDlg;
unsigned message;
WORD wParam;
LONG lParam;
