 ...
 *
 */
OLESTATUS FAR PASCAL __export SrvrCreate
 ...
 *
 */
OLESTATUS FAR PASCAL __export SrvrCreateFromTemplate
   (LPOLESERVER lpolesrvr, LHSERVERDOC lhdoc, LPSTR lpszClassName,
 ...
 *
 */
OLESTATUS FAR PASCAL __export SrvrEdit
   (LPOLESERVER lpolesrvr, LHSERVERDOC lhdoc, LPSTR lpszClassName,
    LPSTR lpszDoc, LPOLESERVERDOC FAR *lplpoledoc)
{
    if (!CreateNewDoc (lhdoc, lpszDoc, doctypeEmbedded))
 ...
 *
 */
OLESTATUS FAR PASCAL __export SrvrExecute (LPOLESERVER lpolesrvr, HANDLE hCommands)
{
 ...
 *
 */
OLESTATUS FAR PASCAL __export SrvrExit (LPOLESERVER lpolesrvr)
{
   if (srvrMain.lhsrvr)
 ...
 *
 */
OLESTATUS FAR PASCAL __export SrvrOpen (LPOLESERVER lpolesrvr, LHSERVERDOC lhdoc,
                               LPSTR lpszDoc, LPOLESERVERDOC FAR *lplpoledoc)
{
 ...
 *
 */
OLESTATUS FAR PASCAL __export SrvrRelease (LPOLESERVER lpolesrvr)
{
   if (srvrMain.lhsrvr)
   {
