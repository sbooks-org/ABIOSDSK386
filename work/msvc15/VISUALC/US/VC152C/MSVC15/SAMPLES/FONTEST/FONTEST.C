//Order of includes matter for compile time ... /YX ...
...
void FAR PASCAL PaintMetrics(HDC hdc, PLOGFONT plf, int height);
void FAR PASCAL DrawMetrics(HDC hdc, int x, int y, HFONT hFont, TEXTMETRIC *tm, char *pch);
...
long FAR PASCAL __export MainWndProc(HWND hwnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
	HDC hdc;
	HDC hdcDevice;
	PAINTSTRUCT ps;
...
BOOL FAR PASCAL __export ShowLogFontProc(HWND hDlg, unsigned message, WORD wParam, LONG lParam)
{
