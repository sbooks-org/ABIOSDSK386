...
*
*	This module should be isolated from the rest of MOVE's code so it can
*	be replaced at link time, as appropriate.
*
*******************************************************************************/
...
unsigned short _far __cdecl __movegetenv (
char _far * lpszName
)
    {
    _asm
